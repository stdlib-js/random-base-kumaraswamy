...
tape( 'the function returns a seeded pseudorandom number generator (integer seed)', function test( t ) {
	...
	for ( i = 0; i < 1e3; i++ ) {
		r1 = kumaraswamy1();
		r2 = kumaraswamy2();
		t.strictEqual( r1, r2, 'both return same number: '+r1 );
	}
	t.end();
});
...
tape( 'attached to the returned function is the generator name', function test( t ) {
	...
	t.strictEqual( kumaraswamy.NAME, 'kumaraswamy', 'has property' );
	t.end();
});

tape( 'attached to the returned function is the underlying PRNG', function test( t ) {
	var kumaraswamy = factory();
	t.strictEqual( typeof kumaraswamy.PRNG, 'function', 'has property' );

	kumaraswamy = factory({
		'prng': minstd.normalized
	});
	t.strictEqual( kumaraswamy.PRNG, minstd.normalized, 'has property' );
	t.end();
});
...
tape( 'attached to the returned function is the generator seed', function test( t ) {
	...
	t.strictEqual( isUint32Array( kumaraswamy.seed ), true, 'has property' );
	t.strictEqual( kumaraswamy.seed[ 0 ], 12345, 'equal to provided seed' );

	kumaraswamy = factory({
		'seed': 12345,
		'prng': minstd.normalized
	});
	t.strictEqual( kumaraswamy.seed, null, 'equal to `null`' );
	t.end();
});
...
tape( 'attached to the returned function is the generator seed length', function test( t ) {
	var kumaraswamy = factory();
	t.strictEqual( typeof kumaraswamy.seedLength, 'number', 'has property' );

	kumaraswamy = factory({
		'prng': minstd.normalized
	});
	t.strictEqual( kumaraswamy.seedLength, null, 'equal to `null`' );
	t.end();
});

tape( 'attached to the returned function is the generator state', function test( t ) {
	var kumaraswamy = factory();
	t.strictEqual( isUint32Array( kumaraswamy.state ), true, 'has property' );

	kumaraswamy = factory({
		'prng': minstd.normalized
	});
	t.strictEqual( kumaraswamy.state, null, 'equal to `null`' );
	t.end();
});

tape( 'attached to the returned function is the generator state length', function test( t ) {
	var kumaraswamy = factory();
	t.strictEqual( typeof kumaraswamy.stateLength, 'number', 'has property' );

	kumaraswamy = factory({
		'prng': minstd.normalized
	});
	t.strictEqual( kumaraswamy.stateLength, null, 'equal to `null`' );
	t.end();
});

tape( 'attached to the returned function is the generator state size', function test( t ) {
	var kumaraswamy = factory();
	t.strictEqual( typeof kumaraswamy.byteLength, 'number', 'has property' );

	kumaraswamy = factory({
		'prng': minstd.normalized
	});
	t.strictEqual( kumaraswamy.byteLength, null, 'equal to `null`' );
	t.end();
});
...
tape( 'attached to the returned function is a method to serialize the generator as a JSON object', function test( t ) {
	...
	kumaraswamy = factory();
	t.strictEqual( typeof kumaraswamy.toJSON, 'function', 'has method' );

	o = kumaraswamy.toJSON();
	t.strictEqual( o.type, 'PRNG', 'has property' );
	t.strictEqual( o.name, kumaraswamy.NAME, 'has property' );
	...
	t.strictEqual( typeof kumaraswamy.toJSON, 'function', 'has method' );
	t.strictEqual( kumaraswamy.toJSON(), null, 'returns expected value' );
...
tape( 'the function supports specifying the generator state', function test( t ) {
	...
	for ( i = 0; i < 100; i++ ) {
		t.strictEqual( kumaraswamy(), arr[ i ], 'returns expected value. i: '+i+'.' );
	}
	t.end();
});
